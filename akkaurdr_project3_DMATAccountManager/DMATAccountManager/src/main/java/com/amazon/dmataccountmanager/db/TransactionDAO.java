...
public class TransactionDAO implements DAO<Transactions> {
	...
	public int insert(Transactions object) {
		String sql = "INSERT INTO Transactions (shareID, shareCount, pricePerShare, transactionCharges, sttCharges, type, userID) VALUES ('"+object.shareID+"', '"+object.shareCount+"', '"+object.pricePerShare+"',"+object.transactionCharges+","+object.sttCharges+","+object.type+","+object.userID+")";
