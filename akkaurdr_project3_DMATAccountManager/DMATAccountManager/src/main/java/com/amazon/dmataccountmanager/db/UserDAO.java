...
public class UserDAO implements DAO<Users> {
	...
	public int insert(Users object) {
		String sql = "INSERT INTO Users (userName, accountNumber, password, accountBalance) VALUES ('"+object.userName+"', '"+object.accountNumber+"', '"+encryptor.encryptor(object.password)+"', '"+object.accountBalance+"')";
